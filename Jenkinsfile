...
def upstreamProjects = [
  ...
  'io-filesystems', // <groupId>com.aoapps</groupId><artifactId>ao-io-filesystems</artifactId>
  'io-posix', // <groupId>com.aoapps</groupId><artifactId>ao-io-posix</artifactId>
